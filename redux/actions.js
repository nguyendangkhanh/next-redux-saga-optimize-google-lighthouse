const BaseConstants = {
  ...
  IS_MOBILE_LOADER: 'IS_MOBILE_LOADER',
  IS_MOBILE_LOADER_SUCCEED: 'IS_MOBILE_LOADER_SUCCEED',

  TOGGLE_LOADER: 'TOGGLE_LOADER',

  FETCH_METADATA_ASYNC: 'FETCH_METADATA_ASYNC',
  FETCH_METADATA_ASYNC_SUCCEED: 'FETCH_METADATA_ASYNC_SUCCEED',
};
const BaseActions = { 
  fetchMetadata() {
    return { type: Actions.FETCH_METADATA_ASYNC };
  },
  fetchMetadataAsyncSucceed(data) {
    return { type: Actions.FETCH_METADATA_ASYNC_SUCCEED, data };
  },
  isMobileChecker(data) {
    return { type: Actions.IS_MOBILE_LOADER, data };
  },
  toggleLoader(data) {
    return { type: Actions.TOGGLE_LOADER, data };
  },
  isMobileCheckerSucceed(data) {
    return {
      type: Actions.IS_MOBILE_LOADER_SUCCEED,
      data,
    };
  },
  connected() {
  ...
  inactive() {
    // when the app goes out of focus
    return {
